        ...
        <>
            ...
            <main className='container'>
                <div className="py-5 text-center">
                    ...
                    <h2>Booking Page</h2>
                    <p className="lead">Below is an example form built entirely with Bootstrap’s form controls. Each required form group
                    ...
                    <div className="col-md-5 col-lg-4 order-md-last">
                        ...
                        <ul className="list-group mb-3">
                            <li className="list-group-item d-flex justify-content-between lh-sm">
                                <div>
                                    <h6 className="my-0">Trek name</h6>
                    ...
                    <div className="col-md-7 col-lg-8">
                        ...
                        <form className="needs-validation" novalidate>
                            ...
                            <div className="form-check">
                                ...
                                <label className="form-check-label" for="same-address">Shipping address is the same as my billing
                                    address</label>
                            </div>
